...
const YouTube = require('AIzaSyBJrfPXD4a9lBj8tCQFYtC5YyUhAyhI6RM');
...
client.on('message', message => {
  ...
  if (message.content.startsWith('Qاذكار')) {
...
client.on('message', message => {
        ...
        .setTitle(`click her`)
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=559371135033147392&permissions=8&scope=bot`)
...
client.on('message', message => {
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/WZ8JsVd**")
